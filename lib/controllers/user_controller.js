    ...
    try {
        ...
        const mailOptions = {
            ...
            html: `<h1>Please click the link below to set new password</h1>
                    <p><a href="https://www.remruatthanga.com/mystore/api/redirect?url=mystoreadmin://com.remruatthanga.my_store_admin/reset_password?token=${token}">Reset password</a></p>
            `
        }
